...
const plans = [
  {
    ...
    icon: Sparkles,
    features: [
      "50 этикеток 58x40 в день",
      "Объединение WB + Честный Знак",
      "Скачивание PDF для термопринтера",
      "Генератор этикеток онлайн",
    ],
    limitations: [
      "Без Pre-flight проверки DataMatrix",
      "Без истории генераций",
    ],
  ...
  },
  {
    ...
    icon: Zap,
    features: [
      "Безлимитная печать этикеток",
      "Pre-flight проверка DataMatrix",
      "История генераций 30 дней",
      "Приоритетная печать 1000 шт/5 сек",
