...
const faqs = [
  ...
  },
  {
    ...
    answer: "Загрузите PDF от Wildberries и CSV с кодами маркировки → KleyKod объединит их на одной этикетке 58x40 → Скачайте готовый PDF для термопринтера (Xprinter, TSC, Godex). Генерация в 50 раз быстрее ручной работы.",
  },
  {
