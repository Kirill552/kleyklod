...
const faqCategories = [
  {
    ...
    questions: [
      {
        question: "Что такое KleyKod и зачем он нужен?",
        answer: "KleyKod — это онлайн-генератор этикеток для Вайлдберриз и Ozon, который объединяет штрихкод товара и код маркировки Честный Знак (DataMatrix) на одной наклейке 58×40 мм. Вместо двух этикеток на товаре — одна. Это экономит время, материалы и решает проблему «2 стикеров на товаре».",
      },
      {
        question: "Можно ли клеить код Честного Знака и штрихкод WB на одной этикетке?",
        answer: "Да, это полностью легально и соответствует требованиям Wildberries и системы «Честный знак». Главное условие — оба кода должны читаться сканером, не перекрываться и иметь зону покоя минимум 3 мм. KleyKod автоматически размещает коды с соблюдением всех требований.",
      },
      {
        question: "Чем KleyKod лучше wbcon и wbarcode?",
        answer: "KleyKod — единственный сервис с проверкой качества DataMatrix ДО печати (Preflight). Мы проверяем размер ≥22мм, контрастность ≥80%, DPI 203. Также у нас прозрачные цены (бесплатно 50 шт/день навсегда, PRO 490₽/мес), Telegram-бот для генерации без регистрации.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer: "Да! Бесплатный тариф — 50 этикеток в день навсегда. Без ограничений по функциям. Достаточно для FBS селлеров с небольшими объёмами. PRO (500/день) — 490₽/мес, Enterprise (безлимит) — 1990₽/мес.",
      },
      {
        question: "Как работает пробный период?",
        answer: "При регистрации вы получаете 7 дней PRO-тарифа бесплатно: 500 этикеток в день, история генераций, Telegram-бот. После окончания trial автоматически переключается бесплатный тариф (50 шт/день). Карта не требуется.",
      },
      {
        question: "Какие способы оплаты доступны?",
        answer: "Оплата банковской картой через ЮКасса (Visa, MasterCard, МИР). Для Enterprise-клиентов — оплата по счёту для юрлиц. Подписка автоматически продлевается, отменить можно в любой момент в личном кабинете.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer: "Да, @kleykod_bot позволяет генерировать этикетки прямо в Telegram без регистрации на сайте. Отправьте Excel с баркодами и PDF с кодами ЧЗ — получите готовый PDF для печати. Доступен на бесплатном тарифе.",
      },
      {
        question: "Есть ли API для автоматизации?",
        answer: "Да, REST API доступен на тарифе Enterprise. Позволяет интегрировать генерацию этикеток в ваши системы: 1С, МойСклад, собственные CRM. Документация API в личном кабинете после активации тарифа.",
      },
      {
        question: "Работает ли KleyKod с Ozon и другими маркетплейсами?",
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-br from-emerald-600 to-teal-600 rounded-2xl p-8 text-white text-center">
              ...
              <p className="text-emerald-100 mb-6 max-w-lg mx-auto">
                50 этикеток в день бесплатно. Проверка качества DataMatrix до печати.
