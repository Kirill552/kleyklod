/**
 * API Route: Генерация этикеток из Excel с полным дизайном.
 *
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const response = await fetch(
      `${API_URL}/api/v1/labels/generate-from-excel`,
      {
        method: "POST",
        headers: {
    ...
    console.error("Ошибка генерации этикеток из Excel:", error);
