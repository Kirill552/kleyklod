    ...
    <div className="space-y-8">
            ...
            <div className="flex-1 space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div className="px-4 py-3 bg-warm-gray-50 rounded-xl border-2 border-warm-gray-300">
              ...
              <div className="bg-blue-50 border-2 border-blue-600 rounded-xl shadow-[2px_2px_0px_#E7E5E4] p-4">
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          {/* Успех */}
          {labelPrefsSaved && (
            <div className="bg-emerald-50 border-2 border-emerald-600 rounded-xl shadow-[2px_2px_0px_#E7E5E4] p-4 flex items-center gap-3">
          ...
          {!labelPrefsLoading && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border-2 border-warm-gray-300 bg-white
                      focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-600"
                  />
              ...
              <div className="p-4 bg-amber-50 border-2 border-amber-600 rounded-xl shadow-[2px_2px_0px_#E7E5E4]">
                ...
                <div className="space-y-2">
                  {[0, 1, 2].map((index) => (
                    <input
                      ...
                      maxLength={50}
                      className="w-full px-3 py-2 text-sm rounded-xl border-2 border-amber-600 bg-white
              ...
              {(user.plan === "pro" || user.plan === "enterprise") && (
                <div className="p-4 bg-emerald-50 border-2 border-emerald-600 rounded-xl shadow-[2px_2px_0px_#E7E5E4]">
      ...
      {user.plan === "enterprise" && (
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            {newApiKey && (
              <div className="bg-amber-50 border-2 border-amber-600 rounded-xl shadow-[2px_2px_0px_#E7E5E4] p-4 space-y-3">
                ...
                <div className="flex items-center gap-2">
                  <code className="flex-1 px-3 py-2 bg-white border-2 border-amber-600 rounded-xl font-mono text-sm break-all">
                    {newApiKey}
                  </code>
                  <Button
                    variant="secondary"
      ...
      <Card>
        ...
        <CardContent>
          <div className="border-2 border-dashed border-warm-gray-300 rounded-xl p-8">
            <div className="text-center">
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-warm-gray-50 rounded-xl border-2 border-warm-gray-300">
              <div>
      ...
      {/* Выход из аккаунта */}
      <Card className="border-2 border-red-600 shadow-[2px_2px_0px_#E7E5E4] rounded-xl">
