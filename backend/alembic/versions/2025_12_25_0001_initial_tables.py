...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("telegram_id", sa.String(255), nullable=False, unique=True, index=True,
        ...
        sa.Column("plan", postgresql.ENUM("free", "pro", "enterprise", name="userplan", create_type=False),
                  nullable=False, server_default="free", comment="Текущий тариф"),
        ...
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False,
                  server_default=sa.func.now(), comment="Дата регистрации"),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False,
                  server_default=sa.func.now(), comment="Дата обновления"),
    )
    ...
    op.create_table(
        ...
        sa.Column("preflight_status", sa.String(20), nullable=True,
    ...
    op.create_table(
        ...
        sa.Column("amount", sa.Integer(), nullable=False,
                  comment="Сумма в минимальных единицах"),
