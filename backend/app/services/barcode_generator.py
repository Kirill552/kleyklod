...
class BarcodeGenerator:
    ...
    def generate(
        ...
        options = {
            "module_width": 0.35,  # Ширина модуля (бара) в мм
            "module_height": height_mm - 5,  # Высота баров (уменьшена чтобы номер был ниже)
            "quiet_zone": 2.5,  # Зона покоя по бокам
            "font_size": 12,  # Размер шрифта под кодом — крупнее
            "text_distance": 5.0,  # Расстояние до текста — УВЕЛИЧЕНО чтобы номер был ПОД штрихкодом
